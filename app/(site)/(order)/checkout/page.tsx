...
// Update the customer details type to include selectedTime
interface CustomerDetails {
  ...
  phoneNumber: string;
  orderDate: Date;
  selectedTime?: TimeSlot; // Add this instead of inspectionTime
...
export default function CheckoutPage() {
  ...
  const form = useForm<CheckoutFormInput>({
    ...
    defaultValues: {
      ...
      postcode: "",
      date: new Date(),
      time: "MORNING" as TimeSlot, // Set default time
      parkingOption: "FREE",
  ...
  useEffect(() => {
    if (customerDetails) {
      reset({
        ...
        date: new Date(),
        time: customerDetails.selectedTime ?? "MORNING", // Use selectedTime instead of inspectionTime
  ...
  const onCheckoutSubmit: SubmitHandler<CheckoutFormInput> = async (data) => {
    setCustomerDetails({
      ...
      orderDate: data.date,
      selectedTime: data.time, // Use selectedTime instead of inspectionTime
