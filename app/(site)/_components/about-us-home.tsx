...
export default function AboutUsHome() {
  return (
    <section className="container  mx-auto grid grid-cols-12 md:gap-20 my-20 md:px-16">
      <div className="col-span-12 lg:col-span-6 flex items-center md:gap-3 max-h-[500px]">
