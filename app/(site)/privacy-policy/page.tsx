  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <section className="mb-6">
        ...
        <p className="mb-2">
          Welcome to London Home Safety Limited . We are committed to protecting
          your personal information and your right to privacy. This Privacy
          Policy explains how we collect, use, disclose, and safeguard your
          information when you visit our website londonhomesafety.com and use
          our services.
        </p>
        <p>
          Our services include Electrical Installation Condition Reports,
          Portable Appliance Testing, Fuse Box Installation, Electrical
          Diagnostic & Repair Services, EV Charger Installation, Gas Certificate
          & Repairs, Boiler Service & Repair, Fire Risk Assessment, Fire Alarm
          Certificate, Fire Alarm Installation, Emergency Light Installation,
          Energy Performance Certificate, Asbestos Surveys, and Inventory
          Services.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p className="mb-2">
          ...
          register on our website, place an order, subscribe to our newsletter,
          respond to a survey, fill out a form, or enter information on our
        ...
        <ul className="list-disc list-inside ml-4 mb-2">
          ...
          <li>Property details relevant to the services you request</li>
          <li>
            Information about your home&apos;s electrical, gas, and safety
            systems
          </li>
        </ul>
        <p className="mb-2">
        ...
        <ul className="list-disc list-inside ml-4">
          ...
          <li>Other technology on the devices you use to access our website</li>
        </ul>
      </section>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc list-inside ml-4 mb-2">
          ...
          <li>
            Send administrative information, such as order confirmations and
            service updates
          </li>
          ...
          <li>
            Conduct data analysis and research to improve our services and
            customer experience
          </li>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc list-inside ml-4">
          ...
          <li>
            To comply with the law: We may disclose your information where we
      ...
      <section className="mb-6">
        ...
        <p className="mb-2">
          We use Stripe for payment processing. Their use of your personal
          information is governed by their respective privacy policies. We
          recommend that you review Stripe&apos;s privacy policy to understand
          how they process your payment information.
        </p>
        <p>
