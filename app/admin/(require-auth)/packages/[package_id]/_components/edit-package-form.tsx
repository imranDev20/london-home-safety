...
export default function EditPackageForm({
  ...
  const breadcrumbItems = [
    ...
    {
      label: `Edit ${packageDetails?.name}`,
      href: `/admin/orders/${packageDetails?.name}`,
      isCurrentPage: true,
    },
  ];
  ...
  return (
    <ContentLayout title="Edit Package">
      ...
      <Form {...form}>
        <form
          onSubmit={handleSubmit(onUpdatePackage)}
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div>
                ...
                <p className="text-gray-600 text-sm sm:text-base block sm:hidden">
                  Please fill out the details below to update a package.
                </p>
              </div>
