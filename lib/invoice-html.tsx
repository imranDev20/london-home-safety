    ...
    <div class="container">
        <header class="header">
            <div class="logo-container">
               <img src="data:image/svg+xml;base64,${base64Logo}" alt="London Home Safety Logo" class="logo">
